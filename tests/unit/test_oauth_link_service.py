...
def test_generate_cold_start_oauth_link_creates_pending_oauth(monkeypatch) -> None:
...
def test_generate_cold_start_oauth_link_requires_client_id(monkeypatch) -> None:
