...
class TestNotificationRouting:
    ...
    def test_stop_digest_routes_correctly(
        ...
        mock_user_state["messages"] = [HumanMessage(content="Stop sending me weekly digests")]
        ...
        notification_calls = [tc for tc in tool_calls if tc["name"] == "manage_notifications"]
        ...
        assert call_args.get("enabled") is False, f"Expected enabled=False, got: {call_args}"
    ...
    def test_unsubscribe_routes_correctly(
        ...
        mock_user_state["messages"] = [HumanMessage(content="Unsubscribe from the weekly emails")]
        result = supervisor_node(mock_user_state)
    ...
    def test_turn_on_digest_routes_correctly(
        ...
        mock_user_state["messages"] = [HumanMessage(content="Turn the weekly digest back on")]
        result = supervisor_node(mock_user_state)
    ...
    def test_notification_tool_receives_correct_league_id(
        ...
        mock_user_state["messages"] = [HumanMessage(content="Please turn off the weekly digest")]
        result = supervisor_node(mock_user_state)
    ...
    def test_notification_tool_uses_weekly_digest_type(
        ...
        mock_user_state["messages"] = [HumanMessage(content="Stop the weekly digest emails")]
        result = supervisor_node(mock_user_state)
