...
def upgrade() -> None:
    ...
    sa.CheckConstraint('user_email IS NOT NULL OR phone_number IS NOT NULL', name='ck_pending_oauth_has_identifier'),
...
def downgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
